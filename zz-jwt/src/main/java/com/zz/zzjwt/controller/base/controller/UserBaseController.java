package com.zz.zzjwt.controller.base.controller;
...
public class UserBaseController {
    ...
    @ResponseBody
    public ResultVO<UserEntity> addUser(UserEntity userEntity, Long roleId){
    ...
    @ResponseBody
    public ResultVO<UserEntity> updateUser(UserEntity userEntity, Long roleId){
    ...
    @ResponseBody
    public ResultVO<RoleEntity> oleRole(Long id){
